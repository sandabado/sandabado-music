...
export type Body = "Physical" | "Mental" | "Emotional" | "Spiritual" | "Etheral"
...
export const elementToBody: Record<Element, Exclude<Body, "Etheral">> = {
  Fire: "Physical", Air: "Mental", Water: "Emotional", Earth: "Spiritual",
}

export const bodyToPillar: Record<Body, PillarId> = {
  Physical: "presence", Mental: "press", Emotional: "studios", Spiritual: "foundation", Etheral: "guardian",
}
...
export const placementWeights = {
  ...
  northNode: { label: "North Node", weight: 7, description: "Soul direction and growth edge" },
...
export function signToBody(sign: string): Exclude<Body, "Etheral"> {
